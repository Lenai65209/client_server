...
from my_common.variables import DEFAULT_PORT, MAX_CONNECTIONS, ACTION, TIME, \
...
class Server:
    ...
    @log
    def parse_client_message(self, message, messages_list, client, clients, names):
        ...
        while True:
            ...
            if recv_data_lst:
                for client_with_message in recv_data_lst:
                    try:
                        self.parse_client_message(accept_message(client_with_message),
...
if __name__ == '__main__':
    try:
        MAX_CONNECTIONS = int(input('Введите максимальное число соединений '))
