...
class Client:
    ...
    @log
    def create_message(self, sock, account_name='Lena'):
    ...
    @log
    def create_server_request(self, account_name='Lena'):
    ...
    def main(self):
        ...
        try:
            ...
            send_message(transport, self.create_server_request(client_name))
            answer = self.process_response_ans(accept_message(transport))
            LOGGER.info(
